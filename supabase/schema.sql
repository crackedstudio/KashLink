...
create table if not exists public.events (
  ...
  value_luna   bigint      not null check (value_luna >= 0 and value_luna < 1e15),
  -- Nimiq address: "NQ12 ABCD ... " — 2 digits plus 8 groups of 4.
  link_address text        not null check (link_address ~ '^NQ[0-9]{2}( [A-Z0-9]{4}){8}$'),
